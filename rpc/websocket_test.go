...
func TestWebsocketOriginCheck(t *testing.T) {
	...
	wantErr := wsHandshakeError{err: websocket.ErrBadHandshake, status: "403 Forbidden"}
...
func TestClientWebsocketPing(t *testing.T) {
	...
	// This is important for reproducing https://github.com/3JoB/go-ethereum/issues/19798
	<-ctx.Done()
	close(sendPing)
...
func TestClientWebsocketLargeMessage(t *testing.T) {
	...
	srv.RegisterName("test", largeRespService{length: respLength})
